...
export const Greek = [
  ...
  "Just be yourself :)",
  "Mention something about the last relationship you've been in",
  "Steal some fire from the Gods and give it to man",
  "Release hell on the conversation by saying something that you will immediately regret saying",
  ...
  "Everyone in the group chat is madly, madly in love with you. At least you think so",
  "Next time you address the person with the longest hair, turn to stone the moment you look at them",
  "You are Hermes, the messenger god, and the guider of souls",
  "You are the Muse known as Calliope, and are reknown for your epic poetry and beauty in song",
  "You are Dionysus, god of parties, drunkeness, and other less important things. Have fun :)",
  "Drag someone to the Underworld by saying an opinion you don't believe and trying really hard to get just one person to agree",
